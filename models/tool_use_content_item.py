...
class ToolUseContentItem(BaseModel):
    ...
    type: StrictStr
    tool_use: ToolUse
    __properties: ClassVar[List[str]] = ["type", "tool_use"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ToolUseContentItem from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ToolUseContentItem from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "tool_use": ToolUse.from_dict(obj["tool_use"]) if obj.get("tool_use") is not None else None
        })
        return _obj
