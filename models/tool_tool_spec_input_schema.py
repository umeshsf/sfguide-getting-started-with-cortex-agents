...
class ToolToolSpecInputSchema(BaseModel):
    ...
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default=None, description="The type of the input schema object")
    properties: Optional[Dict[str, Any]] = Field(default=None, description="Definitions of each input parameter")
    required: Optional[List[StrictStr]] = Field(default=None, description="List of required input parameter names")
