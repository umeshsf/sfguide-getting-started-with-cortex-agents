...
class ThinkingContentItem(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["type", "thinking"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ThinkingContentItem from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ThinkingContentItem from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "thinking": ThinkingContent.from_dict(obj["thinking"]) if obj.get("thinking") is not None else None
        })
        return _obj
