...
class WebSearchCitation(BaseModel):
    ...
    text: StrictStr
    __properties: ClassVar[List[str]] = ["start_index", "end_index", "source_url", "text"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WebSearchCitation from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WebSearchCitation from a dict"""
        if obj is None:
            return None
